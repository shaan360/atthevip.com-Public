...
class ClubEdenHollywoodCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://www.wantickets.com/Venues/5425/EDEN-NIGHTCLUB/';
    public $eventLinks = array();
    public $commandName = 'ClubEdenHollywoodCommand.php';

<?php
/**
 * level 3 event importer
 *
 */

require_once( Yii::getPathOfAlias('application.extensions') . '/wantTicketsImporter.php'); 
 
class ClubLevel3HollywoodCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://wantickets.com/Venues/947/LEVEL-3/';
    public $eventLinks = array();
    public $commandName = 'ClubLevel3HollywoodCommand.php';

<?php
/**
 * avalon event importer
 *
 */

require_once( Yii::getPathOfAlias('application.extensions') . '/wantTicketsImporter.php'); 
 
class ClubAvalonHollywoodCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://wantickets.com/Venues/106/AVALON-HOLLYWOOD/';
    public $eventLinks = array();
    public $commandName = 'ClubAvalonHollywoodCommand.php';

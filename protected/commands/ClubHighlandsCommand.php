<?php
/**
 * highland event importer
 *
 */

require_once( Yii::getPathOfAlias('application.extensions') . '/wantTicketsImporter.php'); 
 
class ClubHighlandsCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://wantickets.com/Venues/2649/THE-HIGHLANDS/';
    public $eventLinks = array();
    public $commandName = 'ClubHighlandsCommand.php';

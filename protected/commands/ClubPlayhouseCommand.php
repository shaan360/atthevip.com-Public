<?php
/**
 * playhouse event importer
 *
 */

require_once( Yii::getPathOfAlias('application.extensions') . '/wantTicketsImporter.php'); 
 
class ClubPlayhouseCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://wantickets.com/Venues/3116/PLAYHOUSE/';
    public $eventLinks = array();
    public $commandName = 'ClubPlayhouseCommand.php';

...
class ClubTruHollywoodCommand extends CConsoleCommand {
    public $eventsHomePage = 'http://www.wantickets.com/Venues/197/TRU-HOLLYWOOD/';
    public $eventLinks = array();
    public $commandName = 'ClubTruHollywoodCommand.php';
